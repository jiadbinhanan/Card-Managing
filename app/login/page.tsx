...
import { ArrowRight, ChevronLeft, Fingerprint, Lock, Mail, Sparkles } from "lucide-react";
...
type ViewState = "login" | "forgot-email" | "forgot-otp";
              ...
              <form onSubmit={handleLogin} className="space-y-5">
                ...
                <motion.div variants={itemVariants} className="pt-4">
                  <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                    <Button 
                      type="submit"
                      className="w-full h-12 rounded-xl bg-gradient-to-r from-[#0ea5e9] to-[#a855f7] hover:opacity-90 text-white font-semibold text-base shadow-[0_0_20px_rgba(14,165,233,0.3)] transition-all hover:shadow-[0_0_25px_rgba(168,85,247,0.4)] border-0"
                    >
                      Login to Dashboard
                ...
                <motion.div variants={itemVariants} className="pt-2">
                  <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                    <Button 
                      ...
                      className="w-full h-12 rounded-xl bg-white text-black hover:bg-slate-200 font-semibold text-base transition-all border-0"
                    >
                      Send Code
            ...
            >
              ...
              <div className="space-y-8 flex flex-col items-center">
                ...
                <motion.div variants={itemVariants} className="w-full space-y-3">
                  <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                    <Button 
                      className="w-full h-12 rounded-xl bg-gradient-to-r from-[#a855f7] to-[#0ea5e9] hover:opacity-90 text-white font-semibold text-base shadow-[0_0_20px_rgba(168,85,247,0.3)] transition-all border-0"
                    >
                      Verify & Reset
                    </Button>
                  </motion.div>
